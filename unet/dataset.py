...
class gridDataset(data.Dataset):
    def __init__(self, data_path, isTrain=True, isFirstTime=False):
        ...
        if isFirstTime:
            ...
            self.input = np.load('/mnt/pami23/stma/weather/processed_data/input.npy')
            self.rain = np.load('/mnt/pami23/stma/weather/processed_data/rain.npy')
            self.temp = np.load('/mnt/pami23/stma/weather/processed_data/temp.npy')
        ...
        self.mean = torch.load('/mnt/pami23/stma/weather/processed_data/mean.pth').numpy()
        self.std = torch.load('/mnt/pami23/stma/weather/processed_data/std.pth').numpy()
