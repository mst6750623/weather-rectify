...
class ConvUNet(nn.Module):
    def __init__(self, in_channels, n_classes, bilinear=True, **kwargs):
        ...
        self.down1 = Downsample(2, 64 // self.coeff, 128 // self.coeff, 3, 1)
        self.down2 = Downsample(2, 128 // self.coeff, 256 // self.coeff, 3, 1)
        self.down3 = Downsample(2, 256 // self.coeff, 512 // self.coeff, 3, 1)
        self.down4 = Downsample(2, 512 // self.coeff, 1024 // self.coeff, 3, 1)

        self.up1 = Upsample(2, 1024 // self.coeff, 512 // self.coeff, 3, 1,
                            bilinear)
        self.up2 = Upsample(2, 512 // self.coeff, 256 // self.coeff, 3, 1,
                            bilinear)
        self.up3 = Upsample(2, 256 // self.coeff, 128 // self.coeff, 3, 1,
                            bilinear)
        self.up4 = Upsample(2, 128 // self.coeff, 64 // self.coeff, 3, 1,
                            bilinear)
